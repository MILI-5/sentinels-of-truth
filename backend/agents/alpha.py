...
def investigate_claim(
    ...
    """
    Agent Alpha investigates a claim
    by searching the existing knowledge base.

    Only search results within the distance threshold
    are treated as relevant evidence.
    """
...
if __name__ == "__main__":
    ...
    claim = "What revolves around the Sun?"
